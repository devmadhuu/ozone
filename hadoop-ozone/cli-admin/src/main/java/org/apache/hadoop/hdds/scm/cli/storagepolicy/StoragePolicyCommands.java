...
/**
 * Subcommand group for storage-policy related operations
 * (SCM admin, invoked via {@code ozone admin storagepolicy}).
 */
@Command(
    name = "storagepolicy",
    aliases = {"sp"},
    description = "StoragePolicy specific operations",
