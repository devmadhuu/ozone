  ...
  public static class DbTableIter<Value> implements
    ...
    private void getNextKey() throws IOException {
      while (tableIterator.hasNext() && currentKey == null) {
        ...
        if (!keyExistsInCache.test(entryKey)) {
