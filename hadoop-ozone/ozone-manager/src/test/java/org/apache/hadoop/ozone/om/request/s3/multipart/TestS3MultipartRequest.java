...
public class TestS3MultipartRequest {
  ...
  public void setup() throws Exception {
    ...
    when(ozoneManager.getBucketInfo(anyString(), anyString())).thenReturn(bucketInfo);
    when(bucketInfo.getStoragePolicy()).thenReturn(OzoneStoragePolicy.getDefaultPolicy());
